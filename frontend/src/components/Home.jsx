...
const Home = () => {
  ...
  return (//bg-bg1 bg-cover min-h-screen flex flex-col bg-gradient-to-r from-[#F0E7C8] via-[#FDF8E5] to-[#A4A890] min-h-screen
    <div className="bg-bg2 bg-cover min-h-screen min-w-screen flex flex-col">
      <Header />
